...
class _StripePaymentWebState extends State<StripePaymentWeb> {
  ...
  String get initialUrl =>
      'https://goevent.zozostudio.tech/stripe/index.php?name=${payCard!.name}&email=${payCard!.email}&cardno=${payCard!.number}&cvc=${payCard!.cvv}&amt=${payCard!.amount}&mm=${payCard!.month}&yyyy=${payCard!.year}';
  @override
    ...
    if (_scaffoldKey.currentState == null) {
      ...
      return Scaffold(
          ...
          appBar: AppBar(
              ...
              elevation: 0.0),
          body: Center(child: isLoadingIndicator()));
    }
  }
